...
<div id="wrapper">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   ...
   <div id ="IR">
<fieldset>
    <form action="../Post/Post_avanArgent.php" method="POST">
   ...
   <tr>
       <td> Matricule Employe </td>
                <td>
                 ...
                 <td>Type d'avantage </td><td><input type="texte" id="Type_avantageArg" name="typeavantage" required></td> 
                 <td>Montant d'avantage </td><td><input type="texte" id="Mantant_AvatgArg" name="MT_avantage"  required></td></tr>     
    </table> 
       ...
       <?PHP
                     $req=$bdd->query("select * from avantage_argent");
                   ?>    
  <div class="table-responsive">
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['IdEmploye']?></td>
                            <td><?php echo $ligne['Type_Avantage_arg']?></td>
                              <td><?php echo $ligne['Montant_Avan_arg']?></td>
                        
                            <td><a role="button" onClick="return conf(this,<?php echo $ligne['IdAvantageArgent']?>)"> <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
                        <?php }?>
                   </tbody>
       ...
       <fieldset>
           <form action="../Post/Post_avtNature.php" method="POST">
  ...
  <table style="text-align: center;" id="tabe1">
   <tr>
       <td> Matricule Employe </td>
         ...
         <?PHP
                     $req=$bdd->query("select * from avantage_nature");
                   ?> 
       <div class="table-responsive">
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['Employe_IdEmploye']?></td>
                            <td><?php echo $ligne['Type_Avantage']?></td>
                              <td><?php echo $ligne['Montant_Avantage']?></td>
                        
                            <td><a role="button" onClick="return confirmer(this,<?php echo $ligne['IdAvantageArg']?>)"> <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
                        <?php }?>
                   </tbody>
...
<script> 
    ...
    function conf(element,id)
    {
      if(confirm("Voulez-vous vraiment supprimer ce cours ?"))
      {
        ...
        element.href='../Post/Delete/Delete_avantageargent.php?IdAvantageArgent='+id;
              return true;
      }
      return false;
    }
    ...
    function confirmer(element,id)
    {
      ...
      {
        //element.setAttribute("href", 'post/confirmer.php?email='+email+'&id_cours='+id);
        element.href='../Post/Delete/Delete_avanNature.php?IdAvantageArg='+id;
              return true;
      }
      return false;
    }
