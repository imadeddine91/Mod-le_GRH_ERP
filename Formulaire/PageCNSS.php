...
<div class="contre">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   <li style="">
    ...
    <div id ="IR">
<fieldset>
      <form action="../Post/Post_add_cnss.php" method="POST">
  <legend> CNSS  </legend><br/>
  <table style="text-align: center;" id="tabe1">
      <tr>   <td>Taux Salarial</td><td><input type="texte"  id="Debut Tranche"  required name="tau_CNSS_Sal"></td>
             <td> Plafond Salarial  </td> <td><input type="texte"  id="Fin Tranche" required name="plaf_CNSS"></td>
        </tr>
        <tr>   <td>Taux Patronal</td><td><input type="texte"  id="Debut Tranche"  required name="tau_CNSS_Pla"></td>
             <td> </td> <td></td>
        </tr>
         ...
         <?PHP
                     $req=$bdd->query("select * from cnss");
                   ?> 
  ...
  <div class="table-responsive">
               <table class="table table-hover">
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['TauxSalarial']?></td>
                            <td><?php echo $ligne['PlafondSalarial']?></td>
                            <td><?php echo $ligne['TauxPatronale']?></td>
                        
                            <td><a role="button" onClick="return confirmer(this,<?php echo $ligne['TauxSalarial']?>)"> <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
...
<script> 
    ...
    function confirmer(element,id)
    {
      if(confirm("Voulez-vous vraiment supprimer ce cours ?"))
      {
        ...
        element.href='../Post/Delete/Delet_CNSS.php?TauxSalarial='+id;
              return true;
      }
      return false;
    }
