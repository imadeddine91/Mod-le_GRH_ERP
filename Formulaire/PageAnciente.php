...
<div class="contre">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   ...
   <div id ="IR">
<fieldset>
    <form action="../Post/Post_add_Anciente.php" method="POST">
  <legend> Anciennete </legend>
  <table style="text-align: center;" id="tabe1">
      <tr><td> Debut Tranche</td><td><input type="texte"  id="Debut Tranche"  required name="debu_tar_ANc"></td>
            <td> Fin Tranche </td> <td><input type="texte"  id="Fin Tranche" required name="fin_tar_ANc"></td>
        </tr>
	<tr><td  > Taux Anciennete </td><td colspan="2"><input type="texte" id="Somme Reduire"  required name="taux_ANc"></td>
            <td ></td>
        </tr>
	     ...
	     <div id = "center">
          ...
          <?PHP
                     $req=$bdd->query("select * from anciennete");
                   ?>  
  <div class="table-responsive">
               <table class="table table-hover">
                  ...
                  <?php  while($ligne=$req->fetch()) { ?>  
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['DebutTranche']?></td>
                            <td><?php echo $ligne['FinTranche']?></td>
                          
                            <td><?php echo $ligne['TauxAnciennete']?></td>
...
<script> 
    ...
    function confirmer(element,id)
    {
      if(confirm("Voulez-vous vraiment supprimer ce cours ?"))
      {
        ...
        element.href='../Post/Delete/Delet_Anciente.php?DebutTranche='+id;
              return true;
      }
      return false;
    }
