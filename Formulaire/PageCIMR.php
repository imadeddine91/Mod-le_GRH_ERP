...
<div class="contre">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   <li style="">
    ...
    <div id ="IR">
<fieldset>
     <form action="../Post/Post_add_cimr.php" method="POST">
  <legend> CIMR  </legend>
  <table style="text-align: center;" id="tabe1">
      <tr>   <td>Taux CIMR Salarial</td><td><input type="texte"  id="Debut Tranche"  required name="tau_CIMRs"></td>
             <td> Taux CIMR  Patronale </td> <td><input type="texte"  id="Fin Tranche" required name="tau_CIMRP"></td>
        </tr>
         ...
         <?PHP
                     $req=$bdd->query("select * from cimr");
                   ?> 
  ...
  <div class="table-responsive">
               <table class="table table-hover">
                   <thead>
                       <tr>
                           <th>Id Taux CIMR </th>
                           <th>Taux CIMR Salarial</th>
                            <th>Taux CIMR  Patronale</th>
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['idCIMR']?></td>
                            <td><?php echo $ligne['TauxCIMRsalarial']?></td>
                              <td><?php echo $ligne['TauxCIMRpatronale']?></td>
                        
                            <td><a role="button" onClick="return confirmer(this,<?php echo $ligne['idCIMR']?>)"> <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
                        <?php }?>
                   </tbody>
                 </table>
...
<script> 
  ...
  element.href='../Post/Delete/Delet_CIMR.php?idCIMR='+id;
              return result;
      }
      return false;
    }
