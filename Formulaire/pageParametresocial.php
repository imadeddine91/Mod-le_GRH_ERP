...
<title> Page_Paramétre Social </title>
 ...
 <div id="wrapper">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   <li style="">
    ...
    <div id ="IR">
<fieldset>
    <form action="../Post/Post_add_parsocial.php" method="POST">
  <legend> Paramétre Social  </legend>
  <table style="text-align: center;" id="tabe1">
      <tr><td> <p>Nombre Heure Jour</p></td><td><input type="texte"  id="Debut Tranche"  required name="Nbr_heuJour"></td>
            <td> Nombre Heure Mois </td> <td><input type="texte"  id="Fin Tranche" required name="Nbr_heuMois"></td>
        </tr>
        <tr><td>Taux horaire Normal</td><td><input type="texte"  id="Debut Tranche"  required name="Tau_horNor"></td>
            <td> Taux Assurance Normal </td> <td><input type="texte"  id="Fin Tranche" required name="Tau_AssurNormal"></td>
        </tr>
      ...
      <?PHP
                     $req=$bdd->query("select * from paramesocial");
                   ?> 
  <div class="table-responsive">
               <table class="table table-hover">
                   <thead>
                       <tr>
                           <th>Nombre Heure Jour</th>
                            <th>Nombre Heure Mois</th>
                             <th>Taux horaire Normal</th>
                            <th>Taux Assurance Normal</th>
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['nbrHeureJour']?></td>
                            <td><?php echo $ligne['nbrHeurMois']?></td>
                            <td><?php echo $ligne['TauxHoraireNormal']?></td>
                            <td><?php echo $ligne['TauxAssuranceNormal']?></td>
                          
                           
                            <td><a role="button" onClick="return confirmer(this,<?php echo $ligne['nbrHeureJour']?>)">
 ...
 <script> 
    ...
    function confirmer(element,id)
    {
      if(confirm("Voulez-vous vraiment supprimer ce cours ?"))
      {
        ...
        element.href='../Post/Delete/Delet_ParSocial.php?nbrHeureJour='+id;
              return true;
      }
      return false;
    }
