   ...
   <li style="">
       <a  style="font-size: 15px ;color: background ;font-weight: bold;font-style: italic"  href="prime.php"><i class="fa fa-plus-circle"></i>__Prime</a>
        ...
        <div class="colonedroit">
          ...
          <div id ="tbtEmplye">
        <form action="../Post/Edit_Employe.php" method="POST">
        <div class="Employe">
              <fieldset>
                   <?php  while($ligne=$req->fetch()) { ?>
              <legend> Edit_Employe </legend>  
              <table style="width: 10% ; height: 90% ">
                    <tr style="width: 0% ; height: 00% ;">
                        
                        <td> Matricule  </td><td><input type="texte"  id="Matricule" name="Matricule"  value="<?php echo $ligne['Matricule']?>"> </td>
                   <td> Nom  </td><td><input type="texte" id="Nom" name="Nom" value="<?php echo $ligne['Nom']?>" required> </td> 
                       <td> Prenom  </td><td><input type="texte" id="prenom" name="prenome" value="<?php echo $ligne['prenom']?>" required></td>
                    ...
                    <tr>
            <td> CIN  </td><td><input type="texte" id="CIN" name="CIN" value="<?php echo $ligne['CIN']?>" required></td>
            <td> Adresse   </td><td><textarea rows="2" cols="19" style="resize: none; " name="addres" value="<?php echo $ligne['Adresse']?>"></textarea></td>
            <td> Date de naissance</td><td><input type="Date" id="date de naissance " name="datenais" value="<?php echo $ligne['Date_naissance']?>" required>
         ...
         <tr>
            ...
            <td> Sexe</td><td><input type="texte" id="Adresse" name="sexe" value="<?php echo $ligne['Sexe']?>" required> </td>
            <td> Situation-familiale</td><td><input type="texte" id="Situation familiale" name="situfam" value="<?php echo $ligne['SituationFamiliale']?>" required></td>
            <td> NbrEnfant</td><td><input type="number" id=" NbrEnfant" name="nbrEnfa" value="<?php echo $ligne['NbrEnfants']?>"  required></td>
            
        </tr>
	<tr>
            <td>  CompteBancaire </td><td><input type="texte" id="  CompteBancaireINT " name="comptbanq" value="<?php echo $ligne['CompteBancaire']?>" required></td>
            <td> NumCNSS </td><td><input type="texte" id=" NumCnss" name="numcnss" value="<?php echo $ligne['NumCnss']?>" required></td><
            <td>   NumCIMR</td><td><input type="texte" id=" NumCimr" name="nucimr" value="<?php echo $ligne['NumCimr']?>" required></td>
            
        
        </tr>
        
        <tr>
            <td>   NumMituelle</td><td><input type="texte" id=" NumCimr" name="nummut" value="<?php echo $ligne['NulMutuelle']?>" required></td>
            
            <td>  Email</td><td><input type="texte" id=" Email" name="email" value="<?php echo $ligne['Email']?>"  required></td>
            <td>  Tel </td><td><input type="texte" id=" Tel INT" name="tel" value="<?php echo $ligne['Tel']?>" required></td><?php }?>
