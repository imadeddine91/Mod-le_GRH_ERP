...
<div class="contre">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" >
   ...
   <div id ="IR">
<fieldset>
    <form action="../Post/Post_primeFixe.php" method="POST">
   <legend> Primes Fixe </legend>
  <table style="text-align: center;" id="tabe1">
      
   <tr>
       <td> Matricule Employe </td>
                <td>
                     <?PHP
    ...
    <td>Type de Prime </td><td><input type="texte" id="Type_PrimeF" name="typePrime"  required></td>
    <td>Non de Prime </td><td><input type="texte" id="nom_PrimeF" name="nomPrimF" required></td>
    <td>valeur de Prime </td><td><input type="texte" id="valer_PrimeF" name="valeurPrif" required></td> </tr>    
    </table> 
       ...
       <?PHP
                     $req=$bdd->query("select * from primesfixes");
                   ?>    
  <div class="table-responsive">
               <table class="table table-hover"  table border="4" id="my_table">
                   <thead>
                       <tr>
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['IdEmploye']?></td>
                            <td><?php echo $ligne['TypePrime']?></td>
                              <td><?php echo $ligne['NomPrime']?></td>
                                <td><?php echo $ligne['ValeurPrime']?></td>
                        
                            <td><a role="button" onClick="return conf(this,<?php echo $ligne['IdPrime']?>)">   <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
                        <?php }?>
                   </tbody>
       ...
       <fieldset>
           <form action="../Post/Post_Primvariable.php" method="POST">
  <legend> Primes variable  </legend>
  <table style="text-align: center;" id="tabe1">
   <tr>
       <td> Matricule Employe </td>
                <td>
           ...
           <td>Type de Prime </td><td><input type="texte" id="Type_PrimeF" name="typePrime"  required></td>
    <td>Non de Prime </td><td><input type="texte" id="nom_PrimeF" name="nomPrimF" required></td>
    <td>valeur de Prime </td><td><input type="texte" id="valer_PrimeF" name="valeurPrif" required></td>        
   </tr>     
    </table> 
         ...
         <?PHP
                     $req=$bdd->query("select * from primesvariables");
                   ?> 
       <div class="table-responsive">
           <table class="table table-hover"  table border="5" >
                   <thead>
                       <tr>
                           <th>Matricule Employe</th>
                            <th>Type de Prime  </th>
                   ...
                   <tbody>
                        <tr>
                           <td><?php echo $ligne['idEmploye']?></td>
                            ...
                            <td><?php echo $ligne['NomPrimesVariablescol']?></td>
                              <td><?php echo $ligne['Valeur']?></td>
                        
                            <td><a role="button" onClick="return confirmer(this,<?php echo $ligne['IdPrimesVariables']?>)">   <i class="fa fa-trash-o"></i> Delete</a></td> 
                       </tr>
                        <?php }?>
                   </tbody>
...
<script> 
    ...
    function conf(element,id)
    {
      if(confirm("Voulez-vous vraiment supprimer ce cours ?"))
      {
        //element.setAttribute("href", 'post/confirmer.php?email='+email+'&id_cours='+id);
        element.href='../Post/Delete/Delete_PrimFixe.php?IdPrime='+id;
              return true;
      }
      return false;
    }
    ...
    function confirmer(element,id)
    {
      ...
      {
        //element.setAttribute("href", 'post/confirmer.php?email='+email+'&id_cours='+id);
        element.href='../Post/Delete/Delete_Primvarible.php?IdPrimesVariables='+id;
              return true;
      }
      return false;
    }
