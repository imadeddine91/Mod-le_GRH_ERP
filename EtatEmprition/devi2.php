...
<table>
    ...
    <tr >
        ...
        <td style="background:#ffffcb;width:50%; height: 50px; "> BULLETIN DE PAIE N°  2 </td>
    </tr>
    
    <tr> 
        <td width=50% style="background:#d9edf7;height: 35px; ">MATRICULE  : F15 </td>
        <td width=50% style="background:#d9edf7; height: 35px;"> NOM ET PRENOME : Kaneza amar    </td>
   
    </tr>
     
    <tr> <td style="width:50% ;background:#d9edf7; height: 30px; "> ECHELLE : 10 </td>
        <td style="width:50% ;background:#d9edf7; height: 30px; "> N°CNSS : 141485 </td></tr>
    <tr> <td style="background:#d9edf7; height: 30px; "> DATE DE NAISSANCE : 1992-07-20 </td>
        <td style="background:#d9edf7; height: 30px;"> DATE DE RECRUTEMENT : 2008-07-01 </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:50% ;">
                <ul>
                <?php  while($ligne=$req->fetch()) { ?>    <li><?php echo $ligne['@sar_base']?>  1900 DH</li><?php }?>
                    <li><?php ?> 0 DH</li>
                    <li><?php ?> 250 DH   </li>
                    <li><?php ?> 1100 DH </li>
                </ul>
    ...
    <br/>
        ...
        <tr>
            <td style="width:50%; height: 35px;;">Totale des gains 4799 </td>
            <td style="width:50%; height: 35px;;">Totale des retenus 1250 DH</td>
        </tr>
      
     <tr>
            
            <td colspan="2" style="width:50% ;background:#ffffcb; height: 35px; "> NET A PAYER                 3549 DH  </td>
